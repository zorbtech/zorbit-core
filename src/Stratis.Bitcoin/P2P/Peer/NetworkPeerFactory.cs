...
namespace Stratis.Bitcoin.P2P.Peer
{
    ...
    public class NetworkPeerFactory : INetworkPeerFactory
    {
        ...
        public NetworkPeerFactory(Network network, IDateTimeProvider dateTimeProvider, ILoggerFactory loggerFactory, PayloadProvider payloadProvider, ISelfEndpointTracker selfEndpointTracker, NodeSettings nodeSettings)
        {
        ...
        public NetworkPeerConnection CreateNetworkPeerConnection(INetworkPeer peer, TcpClient client, ProcessMessageAsync<IncomingMessage> processMessageAsync)
        {
            ...
            return new NetworkPeerConnection(this.network, peer, client, id, processMessageAsync, this.dateTimeProvider, this.loggerFactory, this.payloadProvider, this.nodeSettings);
        }
    }
}